...
const videoSchema = new mongoose.Schema({
  ...
  outputS3Key: { type: String }, // S3 key for processed output video with subtitles
  ...
  subtitleLanguage: { type: String }, // Optional language code requested by user (e.g. "en", "hi")
}, { timestamps: true });
