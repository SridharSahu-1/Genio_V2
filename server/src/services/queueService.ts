...
export const addVideoJob = async (videoUrlOrPath: string, videoKey: string, hfToken: string, videoId: string, docId: string, trimStart?: number, trimEnd?: number, aspectRatio?: string) => {
