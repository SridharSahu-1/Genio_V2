...
import { Sparkles, Mail, Lock, ArrowRight, Video, Eye, EyeOff } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">Transform videos with AI-powered subtitles</p>
        </div>
          ...
          <CardContent className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    required
                    className="bg-slate-800/50 border-slate-700 text-white placeholder:text-slate-500 h-12 focus:border-blue-500 focus:ring-blue-500/20 pr-12"
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
              ...
              <Button
                ...
                className="w-full h-12 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-medium shadow-lg shadow-blue-500/50 transition-all duration-200"
              >
                {isSubmitting ? (
                  <>
        ...
        <div className="mt-8 grid grid-cols-3 gap-4 text-center">
          <div className="p-4 bg-slate-900/50 backdrop-blur-sm rounded-lg border border-slate-800/50">
